'''
General PX4 vehicle controller for Webots 2023a
...
import time
import argparse
from webots_vehicle import WebotsPX4Vehicle
...
def get_args():
    ...
    parser.add_argument("--motors", "-m",
                        ...
                        help="Comma spaced list of motor names in PX4 numerical order (ex --motors \"m1,m2,m3, m4\")")
    parser.add_argument("--reversed-motors", "-r",
                        type=str,
                        default=None,
                        help="Comma spaced list of motors to reverse (starting from 1, in PX4 order)")
    ...
    parser.add_argument("--hil-sensor-rate",
                        type=int,
                        default=50,
                        help="HIL sensor data update rate in Hz (default: 100Hz)")
                        
    parser.add_argument("--heartbeat-rate",
                        type=int,
                        default=1,
                        help="Heartbeat message update rate in Hz (default: 1Hz)")
...
if __name__ == "__main__":
    ...
    vehicle = WebotsPX4Vehicle(motor_names=motors,
                               ...
                               hil_sensor_rate=args.hil_sensor_rate,
